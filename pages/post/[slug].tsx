...
function Post({ post }: Props) {
  ...
  return (
    <main>
      ...
      {submitted ? (
        <div className="flex flex-col justify-center items-center p-10 my-20 bg-yellow-500 text-white max-w-2xl mx-auto">
          <h3 className="text-2xl font-bold">Thank you! Your comment was submitted.</h3>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 120, // cache updates every 120 seconds.
  };
};
